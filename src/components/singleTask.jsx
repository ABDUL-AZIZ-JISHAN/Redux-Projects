...
import {useDeleteTaskMutation, useEditTaskMutation} from '../redux/features/task/tasksApi.js';
;
    ...
    <div className="lws-task">
      ...
      <div className="flex items-center gap-4">
        <div className="flex items-center gap-2">
          <img alt="avatar" src={teamMember.avatar} className="team-avater" />
