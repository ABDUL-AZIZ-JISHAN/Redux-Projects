...
const PostJob = () => {
 const dispatch = useDispatch();
  ...
  onChange={(e) => setSelectRole(e.target.value)} id="lws-JobTitle" name="lwsJobTitle" required>
          ...
          <div className="fieldContainer">
            ...
            <select  onChange={(e) => setJobType(e.target.value)} value={jobType} id="lws-JobType" name="lwsJobType" required>
          ...
          <div className="fieldContainer">
            ...
            <div className="flex border rounded-md shadow-sm border-slate-600">
              ...
              <input value={salary} onChange={(e)=> setSalary(e.target.value)} type="number" name="lwsJobSalary" id="lws-JobSalary" required className="!rounded-l-none !border-0" placeholder="20,00,000" />
            </div>
          </div>
          <div className="fieldContainer">
