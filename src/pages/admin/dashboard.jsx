          ...
          <div className="px-3 md:lg:xl:px-40  py-20 bg-opacity-10">
            <div className="grid grid-cols-1 md:grid-cols-2  gap-6 p-8">
              <Link to="/admin/videos" className="dashboard-item-card">
                ...
                <p className="text-slate-200 mt-3 ">Add Videos</p>
              </Link>
              <Link to="/admin/assignment" className="dashboard-item-card">
                ...
                <p className="text-slate-200 mt-3"> Add Assignment</p>
              </Link>
              <Link to="/admin/quizzes" className="dashboard-item-card">
                ...
                <p className="text-slate-200 mt-3 ">Add Quizzes</p>
              </Link>
              <Link to="/admin/assignment-mark" className="dashboard-item-card">
                ...
                <p className="text-slate-200 mt-3 ">Add Assignment Mark</p>
              </Link>
            </div>
          </div>
        </div>
